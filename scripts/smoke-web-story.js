...
if (savedState.saveVersion !== 8 || savedState.autoStrategy !== '파밍' || !savedState.autoDirector || savedState.frontierPhaseIndex !== 2 || !Array.isArray(savedState.goldLog) || savedState.character.gambleDebt !== 9 || !savedState.character.scars.length || savedState.rogue.fragments !== 2 || !savedState.rogue.perks) throw new Error('저장 버전/경제/파편/전략 상태 저장 실패');
